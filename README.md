...
# Dotpulse.Searchly Package for Neos CMS #

## Composer

### Integration Repository
```
composer config repositories.searchly vcs ssh://hg@bitbucket.org/dotpulse/neos-plugin-searchly
```

### Installation
```
composer require dotpulse/searchly
```
* * *
> ##### License Terms
